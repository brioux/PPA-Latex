...
\begin{subequations}\label{eqBuyersProblem}
	...
	&\qquad	\qquad \phi(\delta, h, l, p, y) =  	 \omega_{\delta}\frac{\delta^{0}-\delta}{\delta^{0}}+\omega_{h}\frac{h-h^{0}}{h^{0}}+\omega_{l}\frac{l-l^{0}}{l^{0}}+\omega_{p}\frac{p^{0}-p}{p^{0}}+\omega_{y}\frac{y-y^{0}}{y^{0}} \label{eqGeneratorRating}\\
